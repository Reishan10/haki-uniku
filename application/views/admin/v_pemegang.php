<div class="main-content-container container-fluid px-4">
    ...
    <div class="row">
        <div class="col-lg-12 col-md-12">
            ...
            <!-- / Add New Post Form -->
            <div>
                <a href="<?= base_url('permohonan/lampiran') ?>" class="btn btn-warning mb-3 ml-2" style="float: right;">Next</a>
                <a href="<?= base_url('permohonan/pencipta') ?>" class="btn btn-secondary mb-3" style="float: right;">Prev</a>
            </div>
        </div>
    </div>
</div>
